...
echo -e "3\n3" | gmx rms -s proteinB1.pdb -f fit_test.xtc -o ca_rmsd_Domain_1_Beta_Propeller_Replica_2.xvg
echo -e "3" | gmx rmsf -s proteinB1.pdb -f fit_test.xtc -res -o ca_rmsf_Domain_1_Beta_Propeller_Replica_2.xvg
echo -e "3" | gmx gyrate -s proteinB1.pdb -f fit_test.xtc -o Rg_Domain_1_Beta_Propeller_Replica_2.xvg
echo -e "1" | gmx sasa -s proteinB1.pdb -f fit_test.xtc -o sasa_Domain_1_Beta_Propeller_Replica_2.xvg
